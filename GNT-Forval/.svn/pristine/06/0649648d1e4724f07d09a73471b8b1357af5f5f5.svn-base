...
/**
 * オプション解約取消処理（WebAPI実行）
 * 
 * @author smis
 */
public class OptionCancelCancelLogic extends AbstractWebApiLogic {

	/** WebAPI実行用のパス */
	private static final String ACTION_PATH = "optionCancelCancel/cancelOptionCancel";
	/** パラメータ 受注番号 */
	 ...
	 */
	public BasicWebApiResDto cancelOptionCancel(String juchNo, String juchMeisaiNo) {

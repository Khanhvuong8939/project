...
<!-- 						TTM_DEV 20170630 UPDATE END -->	
			...
			<!-- TTM_DEV 20180612 BEGIN DELETE -->
				<%-- <c:set var="cardAmerican">/ui/img/<%=FtResourcesUtil.getItemValue("payment_credit_register.label.142")%></c:set> --%>
			<!-- TTM_DEV 20180612 END DELETE -->
				<img src="${f:url(cardUrl)}" alt="利用可能カード一覧" width="320" height="133">
				<table align="center" style="margin:0 auto">
					...
					<tbody>
						<tr>
							...
							<td>
							<!-- TTM_DEV 20180612 BEGIN DELETE -->
								<%--<ft:label key="payment_credit_register.label.144" /> --%>
							<!-- TTM_DEV 20180612 END DELETE -->
							</td>
						</tr>
						<tr>
							...
							<td>
							<!-- TTM_DEV 20180612 BEGIN DELETE -->
								<%-- <img src="${f:url(cardOther)}" alt="利用可能カード一覧" width="200" height="80"> --%>
							<!-- TTM_DEV 20180612 END DELETE -->
							</td>
						</tr>
					</tbody>
